      ...
      <Container style={{ backgroundColor: "#fdfdfd" }}>
        ...
        <Content padder>
          <TouchableHighlight onPress={() => Actions.login()}>
            ...
            >
              ...
              <Text style={{ color: "#fdfdfd" }}>
                حسال کاربری دارید؟ برای ورود اینجا کلیک کنید
              </Text>
            </View>
          </TouchableHighlight>
          <View>
            <Text style={{ marginTop: 15, fontSize: 18 }}>اطلاعات ارسال</Text>
            ...
            <Item regular style={{ marginTop: 7 }}>
              <Input
                placeholder="اصلاعات اضافی"
                onChangeText={text => this.setState({ note: text })}
                placeholderTextColor="#687373"
              />
            </Item>
          </View>
          <Text style={{ marginTop: 15, fontSize: 18 }}>سفارش شما</Text>
          <View style={styles.invoice}>
            <List>{this.renderItems()}</List>
            <View style={styles.line} />
            <Grid style={{ paddingLeft: 10, paddingRight: 10, marginTop: 7 }}>
              <Col>
                <Text style={{ fontSize: 18, fontStyle: "italic" }}>جمع</Text>
              </Col>
              <Col>
                <Text
                  style={{
          ...
          <View style={{ marginTop: 10, marginBottom: 10, paddingBottom: 7 }}>
            ...
            >
              <Icon name="ios-card" />
              <Text style={{ color: "#fdfdfd" }}>بخش فاکتور گیری</Text>
            </Button>
          </View>
        </Content>
      </Container>
