    ...
    const AlangooSubCatagory = (
      <Item picker>
        ...
        >
          ...
          <Picker.Item style={{ textAlign: 'right' }} label="سی ان سی" value="سی ان سی" />
        ...
        <Container style={{ backgroundColor: Colors.statusBarColor }}>
          ...
          <Content>
            <Form style={{ padding: 5 }}>
              ...
              {/* Second subcatagorie */}
              {this.state.selectedSubCat === 'النگو' ? AlangooSubCatagory : <Text />}

              {/* Third subcatagorie */}
              {this.state.alangoo_SubCat === 'سی ان سی' ? AlangooCNC : <Text />}
              {this.state.alangoo_SubCat === 'ریختگی' ? AlangooRikhtegi : <Text />}
              ...
              <Item picker style={{ justifyContent: 'space-between' }}>
                ...
                >
                  ...
                  <Picker.Item label="کالاهای ناموجود اما قابل سفارش" value="key1" />
              ...
              <Button full primary onPress={() => Actions.category({ id: '12', title: 'زنانه' })}>
